...
var $img_path = CAPTCHA_PATH; // Image path
...
var $font_path = CAPTCHA_FONTS; // PATH_TTF
...
if(phpversion() >= 7){
	...
	// $font = str_replace(array('application\libraries','/'),array($this->font_path.'\\','\\'),__DIR__).$sel_font;
