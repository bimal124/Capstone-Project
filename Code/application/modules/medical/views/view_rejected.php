                        ...
                        <table class="table table-striped">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th align="center"><div align="center">Assigned Dr</div></th>
                                 ...
                                 ?>
                                        ...
                                        <tr> 
                                            ...
                                            <td align="left"><div align="center">
                                                <?php print($data->doctor_name.' '.$data->doctor_last_name);?></div></td>
                                            ...
                                            <td colspan="2" align="center" style="border-right:none; font-size:20px;">
                                                ...
                                                <a href="javascript: void(0);" class="assignProvider" data-id="<?php print($data->id);?>" title="Assign Provider"><i class="fa fa-user-md"></i></a>
                                                  <a  style="margin-left:5px;" href="<?php echo site_url(ADMIN_DASHBOARD_PATH);?>/medical/delete/<?php print($data->id);?>" class="text-red" onClick="return doconfirm();" title="Delete"><i class="fa fa-times"></i></a>
