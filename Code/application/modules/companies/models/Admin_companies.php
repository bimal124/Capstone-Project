...
class Admin_companies extends CI_Model 
{
	...
	public $validate_settings_edit =  array(	
			...
			array('field' => 'company_reg_no', 'label' => 'Registration No.', 'rules' => 'trim'),
			array('field' => 'company_addr', 'label' => 'Address', 'rules' => 'trim|required'),
			array('field' => 'company_city', 'label' => 'City', 'rules' => 'trim|required'),
			array('field' => 'company_postal_code', 'label' => 'Post Code/ Zip Code', 'rules' => 'trim|required'),
	...
	public function get_total_companies($status)
	{		
	...
	public function get_companies_details($status,$perpage,$offset)
	{
		if($status) $status = $status; else $status = '0';
	...
	public function count_company_transaction($user_id)
	{
		$option = array('user_id'=>$user_id,'transaction_status'=>'Completed');
		$query = $this->db->get_where('transaction',$option);
		return $query->num_rows();
	}
	public function get_company_transaction($user_id,$perpage,$offset)
	{
		$option = array('user_id'=>$user_id,'transaction_status'=>'Completed');
	...
	function change_company_password()
	{		
		...
		$user_data = $this->get_company_byid($user_id);
	...
	*
	**/
	public function insert_company($salt, $password)
	{
