            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="company_name" type="text" class="form-control form-control" id="company_name" value="<?php echo set_value('company_name',$profile->company_name);?>" size="15" required="required" />
              ...
              <?php /*<div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="company_reg_no" type="text" class="form-control form-control" id="company_reg_no" value="<?php echo set_value('company_reg_no',$profile->company_reg_no);?>" size="15" required="required" />
              ...
              */?>
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="company_addr" type="text" class="form-control form-control" id="company_addr" value="<?php echo set_value('company_addr',$profile->company_addr);?>" size="30" required="required" />
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="company_city" type="text" class="form-control form-control" id="company_city" value="<?php echo set_value('company_city',$profile->company_city);?>" size="15" required="required" />
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <input name="company_postal_code" type="text" class="form-control form-control" id="company_postal_code" value="<?php echo set_value('company_postal_code',$profile->company_postal_code);?>" size="15" required="required" />
              ...
              <div class="col-sm-4">
                <div class="form-group">
                  ...
                  <select name="company_country" class="reg-sel-country form-control" id="company_country" required="required">
					<?php $post_company_country = set_value('company_country',$profile->company_country);?>
