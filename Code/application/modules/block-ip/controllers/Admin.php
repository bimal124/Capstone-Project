...
class Admin extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->data['active_submenu'] = 'blockip_management';
         $this->data['modules_name'] = 'Block IP Management';
        $this->data['modules_heading'] = 'View Block IP Details';
	...
	public function add_ip()
	{
        ...
        $this->data['active_submenu'] = 'blockip_management';
        $this->data['modules_name'] = 'Block IP Management';
        $this->data['modules_heading'] = 'Add Block IP';
        $this->breadcrumb->populate(
        	array(
        		'ADMIN' => ADMIN_DASHBOARD_PATH,
        		'Block IP Management' => '#'
	...
	public function edit_ip($id)
	{
        ...
        $this->data['active_submenu'] = 'blockip_management';
        $this->data['modules_name'] = 'Block IP Management';
        $this->data['modules_heading'] = 'Edit Block IP';
        $this->breadcrumb->populate(
        	array(
        		'ADMIN' => ADMIN_DASHBOARD_PATH,
        		'Block IP Management' => '#'
