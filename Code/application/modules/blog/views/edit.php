        ...
        <form name="member" method="post" action="" enctype="multipart/form-data" accept-charset="utf-8" class="add_member_form" id="uprofile">
            ...
            <div class="row">
              ...
              <div class="col-sm-3">
                <div class="form-group">
                  ...
                  <input name="blogger_name" type="text" class="form-control" id="blogger_name" value="<?php echo set_value('blogger_name',$cms_data->blogger_name);?>" size="15" />
            ...
            <div class="row">
              ...
              <div class="input-group" id="datetime_picker">
                <input name="post_date" type="text" class="form-control" id="post_date" value="<?php echo set_value('post_date',$cms_data->post_date);?>" size="20" autocomplete="off">
              ...
              <div class="col-sm-12">
				...
				<img src="<?php print(site_url(BLOG_IMG_PATH.$cms_data->image));?>" style="max-width:250px;" />
                </div>
              </div>
				</div></div>
              </div>
