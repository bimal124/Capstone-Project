...
class Admin extends CI_Controller {
	...
	public function index()
	{
        ...
        $row = $query->row();
        $this->data['old_pass'] = md5($row->password);
		$this->data['active_menu'] = 'admin-main-menu';
        $this->data['active_submenu'] = 'change-password';
         $this->data['modules_name'] = 'Change Password';
        $this->data['modules_heading'] = 'Change Admin Password';
